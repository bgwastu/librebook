...
class _SearchPageState<T> extends State<_SearchPage<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    final String searchFieldLabel = AppLocalizations.of(context).translate('search-label');
    final TextStyle searchFieldStyle = widget.delegate.searchFieldStyle ?? theme.inputDecorationTheme.hintStyle;
    Widget body;
